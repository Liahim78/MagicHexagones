using System;
using Assets.Scripts.Core.View.Bindings;
...
namespace Assets.Scripts.Core.ViewModel.Properties
{
    public class Property : IProperty
    {
        ...
        public static void UpdateSubscriber(out Func<bool> getter, BooleanBinding.CheckTypes checkType,
            IProperty property,
        ...
        private static bool TryGetProperty<T>(IProperty p, out Property<T> result)
        {
            if (p != null)
            {
        ...
        private static bool CompareReferences(double value, double reference, BooleanBinding.CheckTypes checkType,
            bool defaultValue)
        {
            switch (checkType)
            {
